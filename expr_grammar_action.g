...
non-terminals FUNDEF FUNDEFS FUNCALL ASSIGN_OR_CALL
...
ASSIGN_OR_CALL -> FUNCALL {$1}

FUNCALL -> SYM_LPARENTHESIS CALLPARAMS SYM_RPARENTHESIS SYM_SEMICOLON {fun x -> Node(Tcall, x::[$2])}
